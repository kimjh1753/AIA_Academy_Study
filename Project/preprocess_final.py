...
# print(x_train.shape) # (8000, 44, 44, 3)
...
# print(y_train.shape) # (8000, 176, 176, 3)
...
# for i in range(162771, 163771):
#     i = '{0:06d}'.format(i)
#     val_path = x_val_path + i + second_path
#     a = np.load(val_path)
#     val_list.append(a)
# x_val = np.array(val_list).reshape(-1,44,44,3)
# np.save(x_val_path, arr=x_val)

# x_val = np.load('../project/celeba-dataset/processed/x_val/x_val.npy')
# print(x_val.shape) # (1000, 44, 44, 3)
...
# for i in range(162771, 163771):
#     i = '{0:06d}'.format(i)
#     val_path = y_val_path + i + second_path
#     a = np.load(val_path)
#     val_list.append(a)
# y_val = np.array(val_list).reshape(-1,176,176,3)
# np.save(y_val_path, arr=y_val)

# y_val = np.load('../project/celeba-dataset/processed/y_val/y_val.npy')
# print(y_val.shape) # (1000, 176, 176, 3)
