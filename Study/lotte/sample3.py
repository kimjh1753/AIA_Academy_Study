...
caltech_dir =  '../study/LPD_COMPETITION/train/'
categories = []
...
np.save("../study/LPD_COMPETITION/npy/P_project_x4.npy", arr=X)
np.save("../study/LPD_COMPETITION/npy/P_project_y4.npy", arr=y)
