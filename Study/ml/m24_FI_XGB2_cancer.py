...
# acc :  0.9824561403508771
# ['worst compactness', 'mean symmetry', 'concave points error', 'mean perimeter', 'symmetry error', 'mean compactness', 'worst symmetry', 'mean fractal dimension', 'perimeter error', 'smoothness error']