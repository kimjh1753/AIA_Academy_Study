...
np.save('../data/npy/mnist_x.npy', arr=m_x_train)
np.save('../data/npy/mnist_x.npy', arr=m_x_test)
np.save('../data/npy/mnist_y.npy', arr=m_y_train)
np.save('../data/npy/mnist_y.npy', arr=m_y_test)
...
np.save('../data/npy/fashion_x.npy', arr=f_x_train)
np.save('../data/npy/fashion_x.npy', arr=f_x_test)
np.save('../data/npy/fashion_y.npy', arr=f_y_train)
np.save('../data/npy/fashion_y.npy', arr=f_y_test)

# 8. cifar10
(c10_x_train, c10_y_train), (c10_x_test, c10_y_test) = cifar10.load_data()

np.save('../data/npy/cifar10_x.npy', arr=c10_x_train)
np.save('../data/npy/cifar10_x.npy', arr=c10_x_test)
np.save('../data/npy/cifar10_y.npy', arr=c10_y_train)
np.save('../data/npy/cifar10_y.npy', arr=c10_y_test)

# 9. cifar100
(c100_x_train, c100_y_train), (c100_x_test, c100_y_test) = cifar100.load_data()

np.save('../data/npy/cifar100_x.npy', arr=c100_x_train)
np.save('../data/npy/cifar100_x.npy', arr=c100_x_test)
np.save('../data/npy/cifar100_y.npy', arr=c100_y_train)
np.save('../data/npy/cifar100_y.npy', arr=c100_y_test)
