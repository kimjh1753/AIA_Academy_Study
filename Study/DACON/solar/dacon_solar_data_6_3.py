...
x_train1 = x_train1.reshape(x_train1.shape[0], 1, 1, x_train1.shape[1])
x_train2 = x_train2.reshape(x_train2.shape[0], 1, 1, x_train2.shape[1])
x_val1 = x_val1.reshape(x_val1.shape[0], 1, 1, x_val1.shape[1])
x_val2 = x_val2.reshape(x_val2.shape[0], 1, 1, x_val2.shape[1])
x_test = x_test.reshape(x_test.shape[0], 1, 1, x_test.shape[1])

y_train1 = y_train1.values.reshape(-1, 1)
y_val1 = y_train1.values.reshape(-1, 1)
y_train2 = y_train1.values.reshape(-1, 1)
y_val2 = y_train1.values.reshape(-1, 1)

print(x_train1.shape, x_val1.shape) # (41971, 1, 1, 7) (10493, 1, 1, 7)
print(x_train2.shape, x_val2.shape) # (41971, 1, 1, 7) (10493, 1, 1, 7)
print(y_train1.shape, y_val1.shape) # (41971,) (10493,)
print(y_train2.shape, y_val2.shape) # (41971,) (10493,)
print(x_test.shape) # (3888, 1, 1, 7)
'''
# 2. 모델 구성
