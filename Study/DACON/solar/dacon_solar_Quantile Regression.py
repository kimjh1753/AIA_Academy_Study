...
# train 데이터 불러오기
train = pd.read_csv('../study/DACON/data/train/train.csv', encoding='CP949')
# submission 데이터 불러오기
sub = pd.read_csv('../study/DACON/data/sample_submission.csv', encoding='CP949')
...
columns_indices = {name: i for i, name in enumerate(df_train.columns)}

# Train and Validation split >>>>> train_test_split 
n = len(train)
