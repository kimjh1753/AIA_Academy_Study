...
from tensorflow.keras.applications import DenseNet121, EfficientNetB7
from keras.layers.advanced_activations import LeakyReLU
from keras.models import Sequential, Model
from keras.layers import Activation, Convolution2D, MaxPooling2D, BatchNormalization, Flatten, Dense, Dropout, Conv2D,MaxPool2D, ZeroPadding2D

DenseNet121 = DenseNet121(weights='imagenet', include_top=False, input_shape=(180,320,3)) 
...
rl = ReduceLROnPlateau(monitor='val_loss', factor=0.5, patience=10, verbose=1, mode='auto')
mc = ModelCheckpoint('../study/dacon/data-3/model/transfer.h5', monitor='val_loss', save_best_only=True, mode='auto')

model.fit(train_dataset, epochs = 150, verbose=1, callbacks=[rl, mc])
